...
export class NoteDeFraisVisualisationComponent implements OnInit {
  ...
  constructor(private _authSrv:AuthService, private _ndfSrv:NoteDeFraisService, private _router:Router){} //public dialog: MatDialog) { }

  ngOnInit() {
    this.missionId=1;
      this._authSrv.collegueConnecteObs.subscribe(collegueConnecte => {
        this._ndfSrv.getNoteDeFraisFromMissionId(this.missionId).subscribe((noteDeFraisTab: NdfEntryDto[]) => {
